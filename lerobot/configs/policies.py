...
class PreTrainedConfig(draccus.ChoiceRegistry, HubMixin, abc.ABC):
    ...
    use_amp: bool = False
    normalization_mode: str | None = None # mean_std, quantile or min_max
    ...
    def _save_pretrained(self, save_directory: Path) -> None:
        config_data = draccus.encode(self)
        # The CHOICE_TYPE_KEY for draccus is 'type' by default, as indicated by the error message
        # "Expected a dict with a 'type' key..."
        # self.type property calls self.get_choice_name(self.__class__) which should return the registered name.
        config_data["type"] = self.type
