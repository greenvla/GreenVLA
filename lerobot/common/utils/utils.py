...
def init_logging(is_main: bool = True):
    """Initialize colorful logging using Rich, only for the main process."""

    # Filter to disable logs from non-main processes
    ...
    rich_handler.addFilter(MainProcessFilter())
